...
STEP 3: Using ONLY the data from steps 1 and 2, respond in this EXACT format:
...
**2. Last Attachment:** [datetime or "No attachment found"]
    - Use the startTime from get_data_session if an active session exists
    - If no active session, use the most recent eventDate from CDR
    - TAC from either source (prefer get_data_session if available)
